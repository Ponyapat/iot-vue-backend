...
import { mdiFruitCherries, mdiShield, mdiHumanChild } from "@mdi/js";
import {
  mdiAccountMultiple,
  mdiCartOutline,
          ...
          datasets: [
            {
              ...
              data: [
                result_customer.B2B,
                result_customer.B2C,
                result_customer.Dealer,
                result_customer.Seller,
                result_customer.Dropship,
                result_customer.Other,
              ],
              borderColor: [
                "rgb(255, 99, 132)",
                "rgb(255, 205, 86)",
...
<template>
  ...
  <main-section>
    <div class="grid grid-cols-1 gap-2 lg:grid-cols-4 mb-6 lg:mb-0">
      <card-widget
      ...
      />
      <div class="bg-white dark:bg-gray-900/70 rounded  shadow-sm mx-4 lg:mx-0 mb-5 lg:mb-[41px] ">
        <h3 class="text-lg leading-tight text-black dark:text-white mb-2 pt-4 px-4">
          Board
        </h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-4 shadow-sm">
      <div
        class="col-span-1 md:col-span-2 w-full h-[450px] bg-white dark:bg-gray-900/70 shadow-lg rounded-lg p-10"
      >
        <h1
          class="text-lg leading-tight text-gray-700 font-bold mb-2 dark:text-white"
        >
          พืชพรรณ
        </h1>
        <div>
      ...
      <div
        class="col-span-1 md:col-span-4 w-full h-[450px] bg-white dark:bg-gray-900/70 shadow-lg rounded-lg p-10"
      >
        <h1
          class="text-lg leading-tight text-gray-700 font-bold mb-2 dark:text-white"
        >
