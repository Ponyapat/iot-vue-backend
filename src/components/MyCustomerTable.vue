    ...
    <div class="w-1/4 ml-4 mr-[40px] mt-10">
      <form class="flex items-center">
        ...
        <button ref="myButton" type="button" @click="searchText"
          class="p-2.5 ml-4 sm:ml-16 md:ml-8 lg:ml-4 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
